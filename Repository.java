...
public class Repository {
    ...
    public void addStudent(Student student) {
        String sql = "INSERT INTO tbl_studentDetails(studentId, firstName, lastName, age, email, " +
                "course, yearLevel, gpa, enrollmentDate, contactNumber) " +
                "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                return new Student.StudentBuilder()
                        ...
                        .setEnrollmentDate(rs.getString("enrollmentDate"))
    ...
    public ArrayList<Student> getAllStudents() {
        ...
        try (Statement stmt = connection.createStatement();
            ...
            while (rs.next()) {
                // Use the StudentBuilder (static nested class) to create Student
    ...
    public void updateStudent(Student student) {
        String sql = "UPDATE tbl_studentDetails SET firstName = ?, lastName = ?, age = ?, " +
                ...
                "enrollmentDate = ?, contactNumber = ? WHERE studentId = ?";
