...
public class Main {
    ...
    public static void addStudentInterface(Repository repository, Scanner scanner) {
        ...
        System.out.print("Enter EnrollmentDate: ");
    ...
    public static void updateStudentInterface(Repository repository, Scanner scanner) {
        ...
        System.out.print("Enrollment Date [" + existingStudent.getEnrollmentDate() + "]: ");
        String enrollmentDate = scanner.nextLine();
        if (enrollmentDate.isEmpty()) enrollmentDate = existingStudent.getEnrollmentDate();
